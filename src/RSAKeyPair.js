...
class RSAKeyPair extends LDVerifierKeyPair {
   ...
   *
   * @returns {Promise<RSAKeyPair>} Generates an RSA key pair.
   */
   ...
   *
   * @returns {Promise<RSAKeyPair>} An RSA Key Pair.
   */
   ...
   * @param {object} publicKeyNode - A Node with out a publicKeyPem set.
   */
   ...
   *
   * @param {object} keyNode - A Node with out a publicKeyPem set.
   */
...
RSAKeyPair.suite = SUITE_ID;
RSAKeyPair.keyType = KEY_TYPE;
